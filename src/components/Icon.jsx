// A small monochrome inline-SVG icon set. Single-colour via `currentColor`, so
// icons inherit the surrounding text colour — clean and theme-friendly.
// Stroke style ~ Feather / Lucide.
const PATHS = {
  clock: (
    <>
  ...
  sunrise: (
    <>
      <path d="M12 2v6M4.2 10.2l1.4 1.4M2 18h20M18.4 11.6l1.4-1.4M16 6l-4-4-4 4" />
  ...
  cloudRain: (
    <>
      ...
      <path d="M16 14v4M8 14v4M12 16v4" />
    </>
  ),
  cloudSnow: (
    <>
  ...
  cloudLightning: (
    <>
      <path d="M6 16.3A7 7 0 1 1 15.7 8h1.8a4.5 4.5 0 0 1 1.5 8.7" />
  ...
  sprout: (
    <>
      <path d="M12 21v-9" />
      <path d="M12 12C12 8.5 9.5 6 5.5 6 5.5 9.5 8 12 12 12Z" />
      <path d="M12 13c0-3 2.5-5 6.5-5 0 3-2.5 5-6.5 5Z" />
    </>
  ),
  ...
  medal: (
    <>
      ...
      <path d="M8.5 9 6 2M15.5 9 18 2" />
    </>
  ),
  trophy: (
    <>
      <path d="M7 4h10v5a5 5 0 0 1-10 0V4Z" />
      <path d="M7 6H4.5a2 2 0 0 0 2.2 3M17 6h2.5a2 2 0 0 1-2.2 3" />
      <path d="M12 14v4M8.5 21h7M10 18h4" />
    </>
  ),
  crown: <path d="M4 18h16M4.5 18 3 8l5 3 4-6 4 6 5-3-1.5 10" />,
  home: (
    <>
